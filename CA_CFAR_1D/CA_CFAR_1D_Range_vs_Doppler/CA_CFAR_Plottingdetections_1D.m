function CA_CFAR_DetectionArray = CA_CFAR_Plottingdetections_1D(RangeProfiles_AfterEqNotch, PFA, referenceCells, guardCells)
    %IMPORTANT
    ...
    CA_CFAR_DetectionArray = detectionArray;
%     % Plot Range Profiles
%     fontsize1 = 12;
%     clims = [-40 0];
% 
