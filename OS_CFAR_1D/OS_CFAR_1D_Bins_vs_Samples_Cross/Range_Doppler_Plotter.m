function Range_Doppler = Range_Doppler_Plotter(startRow, endRow, RangeProfiles_AfterEqNotch,PRF_Hz, PFA, referenceCells, guardCells, alpha, pos)
    ...
    time_HRR_profiles = fftshift(ifft(detectionArray,[],1), 1);
    Range_Doppler = detectionArray;
