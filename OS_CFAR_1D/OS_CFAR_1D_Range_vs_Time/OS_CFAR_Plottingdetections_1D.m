...
% referenceCells = 18; %Size of window in question
% guardCells = 2; %total number of guard cells (is divided in 2 for leading and lagging)(must be even number greater than 0)

PFA = 10^-3;    %Probability of false alarm NOTE: it has a lower PFA than CA_CFAR and GOCA_CFAR and SOCA_CFAR
...
title('Range vs Time: OS','fontsize',fontsize1);
